...
var HitAndBlow = /** @class */ (function () {
    ...
    HitAndBlow.prototype.validate = function (inputArr) {
        ...
        var isAllAnswerOption = inputArr.every(function (val) { return _this.answerSource.includes(val); });
        var isAllDifferent = inputArr.every(function (val, i) { return inputArr.indexOf(val) === i; });
        return isLengthValid && isAllAnswerOption && isAllDifferent;
    };
